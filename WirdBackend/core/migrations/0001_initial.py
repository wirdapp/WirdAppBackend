...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('contest_role', models.PositiveSmallIntegerField(choices=[(1, 'member'), (2, 'admin'), (3, 'super_admin'), (4, 'pending_member'), (5, 'deactivated')], default=1)),
                ('contest', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='core.contest')),
        ...
        migrations.CreateModel(
            name='ContestPersonGroups',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('group_role', models.PositiveSmallIntegerField(choices=[(1, 'member'), (2, 'admin')], default=1)),
                ('contest_person', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.contestperson')),
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.group')),
            ],
        ),
        migrations.AddConstraint(
            model_name='contestpersongroups',
            constraint=models.UniqueConstraint(fields=('contest_person_id', 'group_id', 'group_role'), name='unique_group_person', violation_error_message='A person can be a Group member or a Group Admin'),
        ),
        migrations.AddConstraint(
            model_name='contestperson',
            constraint=models.UniqueConstraint(fields=('contest_id', 'person_id'), name='unique_contest_person', violation_error_message="Can't Create more than one person in a contest"),
        ),
    ]
